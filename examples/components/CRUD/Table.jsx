  ...
  body: {
    ...
    columns: [
      {name: 'id', label: 'ID', width: 20, sortable: true, type: 'text', toggled: true, remark: 'Bla bla Bla'},
      {
        ...
        sortable: true,
        searchable: true,
        popOver: {body: 'Popover 内容：${platform}', trigger: 'hover'},
      ...
      {type: 'text', name: 'grade', label: 'CSS grade', quickEdit: {saveImmediately: true, mode: 'inline', type: 'select', options: ['A', 'B', 'C', 'D', 'X']}},
      {
        type: 'operation',
        label: '操作',
        width: 100,
